...
driver.get("https://www.tromilux.com/en/client/skins/geral.php?cat=80")
...
driver.get("https://www.tromilux.com/client/skins/geral.php?idioma_cod=en&cat=80&PAGINA=2")
...
tromilux = pd.DataFrame(data).to_csv("i_wall_s.py.csv", index=False)
driver.close()