...
driver.get("https://www.tromilux.com/client/skins/geral.php?idioma_cod=en&cat=79&PAGINA=1")
...
driver.get("https://www.tromilux.com/client/skins/geral.php?idioma_cod=en&cat=79&PAGINA=2")
...
driver.get("https://www.tromilux.com/client/skins/geral.php?idioma_cod=en&cat=79&PAGINA=3")
...
tromilux = pd.DataFrame(data).to_csv("i_ceiling_s.py.csv", index=False)
driver.close()